...
def calcular_probabilidades():
    ...
    winner_label.config(text=f"Winner is: {winner}")
...
calcular_button = tk.Button(window, text="Calculate", command=calcular_probabilidades)
...
# Añadir el logo a la ventana principal
logo_label = tk.Label(window, image=logo)
logo_label.image = logo
logo_label.grid(row=0, column=0, columnspan=2, rowspan=2, padx=10, pady=10)
