...
# Crear las entradas para los nombres de los equipos
team_1_entry = tk.Entry(root)
team_1_entry.grid(row=0, column=0, padx=10, pady=10)
team_2_entry = tk.Entry(root)
team_2_entry.grid(row=0, column=1, padx=10, pady=10)

# Función para mostrar las banderas seleccionadas
def mostrar_banderas():
    # Obtener el nombre de los equipos
    equipo_1 = team_1_entry.get()
    equipo_2 = team_2_entry.get()
    
    ruta_bandera_1 = banderas[equipo_1]
    ruta_bandera_2 = banderas[equipo_2]

    # Cargar las imágenes de las banderas
    bandera_1 = tk.PhotoImage(file="C:/Users/angel/OneDrive/Documentos/TFM/banderas/" + ruta_bandera_1)
    bandera_2 = tk.PhotoImage(file="C:/Users/angel/OneDrive/Documentos/TFM/banderas/" + ruta_bandera_2)
    
    print(bandera_1)
    # Mostrar las imágenes de las banderas en etiquetas separadas
    tk.Label(root, image=bandera_1).grid(row=1, column=0)
    tk.Label(root, image=bandera_2).grid(row=1, column=1)
...
def calcular_probabilidades():
    ...
    messagebox.showinfo("Resultado", f"Ganador: {winner}\nProbabilidades:\n{team_1_name}: {round(team_1_prob, 2)}\n{team_2_name}: {round(team_2_prob, 2)}")

# Crear el botón "Calcular"
calcular_button = tk.Button(root, text="Calcular", command=calcular_probabilidades)
calcular_button.grid(row=1, column=0, columnspan=2, padx=10, pady=10)


# Crear el botón para mostrar las banderas
mostrar_banderas_button = tk.Button(root, text="Mostrar Banderas", command=mostrar_banderas)
mostrar_banderas_button.grid(row=2, column=0, columnspan=2, padx=10, pady=10)
